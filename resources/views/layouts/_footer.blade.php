<footer aria-labelledby="footer-heading" class="bg-gray-100 text-sm text-gray-500">
    ...
    <div class="flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col p-16 mx-auto md:mb-16">
        <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            ...
            <p class="mt-2 text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptate, porro.</p>
        </div>

        <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                <h2 class="text-gray-800 mb-4">CATEGORIES</h2>

                <nav class="space-y-4">
                    <a class="block hover:text-gray-800">First Link</a>
                    
                    <a class="block hover:text-gray-800">Second Link</a>
                    
                    <a class="block hover:text-gray-800">Third Link</a>
                    
                    <a class="block hover:text-gray-800">Fourth Link</a>
                </nav>
            </div>
    ...
    <div class="text-gray-800 md:px-16 pb-12">
        <div class="flex flex-col md:flex-row items-center justify-center md:justify-between">
            ...
            <a href="https://ywaychitaung.dev" rel="noopener noreferrer" target="_blank" class="tracking-wide">@ywaychitaung</a>
        </div>
    </div>
</footer>